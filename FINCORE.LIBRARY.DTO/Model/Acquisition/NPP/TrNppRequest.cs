namespace FINCORE.LIBRARY.DTO.Model.Acquisition.NPP
{
    public class TrNppRequest
    {
        ...
        public virtual ICollection<TrDealerOrderSourceTacRequest>? TrDealerOrderSourceTac { get; set; }
        public virtual ICollection<TrDealerOrderSourceThirdPartyRequest>? TrDealerOrderSourceThirdParty { get; set; }
    }
}